# Issue Template: Cancel Interview Reschedule Request (FR#IRM-4)

### User Story
See: `Requirement/UserStories/V1/4#InterviewRescheduleRequests/FR#IRM-4-Cancel-Interview-Reschedule-Request.md`

### Functional Requirement
See: `Requirement/Functional/4#InterviewRescheduleRequests/FR#IRM-4 – Cancel Interview Reschedule Request.md`
...
### Acceptance Criteria
- [ ] Endpoint: DELETE /interviewRescheduleRequests/{interviewRescheduleRequestID}
- [ ] Handler: CancelInterviewRescheduleRequestCommandHandler
- [ ] Repository: CancelInterviewRescheduleRequestAsync
- [ ] Entity: InterviewRescheduleRequest
- [ ] SQL: CancelInterviewRescheduleRequest.sql
