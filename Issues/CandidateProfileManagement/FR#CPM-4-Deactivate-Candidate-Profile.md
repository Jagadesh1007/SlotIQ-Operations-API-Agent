# Issue Template: Deactivate Candidate Profile (FR#CPM-4)

### User Story
See: `Requirement/UserStories/V1/2#CandidateProfileManagement/FR#CPM-4-Deactivate-Candidate-Profile.md`

### Functional Requirement
See: `Requirement/Functional/2#CandidateProfileManagement/FR#CPM-4 – Deactivate Candidate Profile.md`
...
### Acceptance Criteria
- [ ] Endpoint: DELETE /candidateProfiles/{candidateProfileID}
- [ ] Handler: DeactivateCandidateProfileCommandHandler
- [ ] Repository: DeactivateCandidateProfileAsync
- [ ] Entity: CandidateProfile
- [ ] SQL: DeactivateCandidateProfile.sql
