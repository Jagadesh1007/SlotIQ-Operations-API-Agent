# Issue Template: Update Candidate Profile (FR#CPM-3)

### User Story
See: `Requirement/UserStories/V1/2#CandidateProfileManagement/FR#CPM-3-Update-Candidate-Profile.md`

### Functional Requirement
See: `Requirement/Functional/2#CandidateProfileManagement/FR#CPM-3 – Update Candidate Profile.md`
...
### Acceptance Criteria
- [ ] Endpoint: PUT /candidateProfiles/{candidateProfileID}
- [ ] Handler: UpdateCandidateProfileCommandHandler
- [ ] Repository: UpdateCandidateProfileAsync
- [ ] Entity: CandidateProfile
- [ ] SQL: UpdateCandidateProfile.sql
