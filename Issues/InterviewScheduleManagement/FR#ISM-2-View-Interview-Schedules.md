# Issue Template: View Interview Schedules (FR#ISM-2)

### User Story
See: `Requirement/UserStories/V1/3#InterviewScheduleManagement/FR#ISM-2-View-Interview-Schedules.md`

### Functional Requirement
See: `Requirement/Functional/3#InterviewScheduleManagement/FR#ISM-2 – Retrieve Interview Schedules.md`
...
### Acceptance Criteria
- [ ] Endpoint: GET /interviewSchedules
- [ ] Handler: GetInterviewSchedulesQueryHandler
- [ ] Repository: GetAllInterviewSchedulesAsync
- [ ] Entity: InterviewSchedule
- [ ] SQL: GetAllInterviewSchedules.sql
